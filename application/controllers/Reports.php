...
class Reports extends CI_Controller {
    ...
    public function summary_scgp(){
        ...
        $data['client']=$this->uri->segment(5);
        $sql="";
    ...
    public function export_summary_scgp(){
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E6', "Item Description");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I6', "Client");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M6', "PO/JO No.");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P6', "Billing Statement No");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('S6', "Qty");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('T6', "Uom");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('U6', "Total Sales");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X6', "Total Cost");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA6', "Gross Profit");
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M2', "Summary of Sales, Costs, and Gross Profit");
        $num=7;
        ...
        foreach($this->super_model->select_custom_where("fifo_out","sales_id='$head->sales_id' AND item_id = '$head->item_id'") AS $sales){
            ...
            $totalsales1=array_sum($totalsales);
            $totalcost[] = $total_unit_cost;
            $totalcost1=array_sum($totalcost);
            $grossprofit[] = $gross_profit;
            $grossprofit1=array_sum($grossprofit);
            ...
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$num, $client);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$num, $po_jo);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P'.$num, $head->billing_no); 
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('S'.$num, $total_qty);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('T'.$num, $unit);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('U'.$num, $total_sales);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.$num, $total_unit_cost);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.$num, $gross_profit);
            $objPHPExcel->getActiveSheet()->getStyle('U'.$num.":AC".$num)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
            $objPHPExcel->getActiveSheet()->getStyle('S'.$num)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
            $objPHPExcel->getActiveSheet()->getProtection()->setSheet(true);    
            $objPHPExcel->getActiveSheet()->protectCells('A'.$num.":AC".$num);
            ...
            $objPHPExcel->getActiveSheet()->mergeCells('I'.$num.":L".$num);
            ...
            $objPHPExcel->getActiveSheet()->mergeCells('U6:W6');
            ...
            $objPHPExcel->getActiveSheet()->getStyle('F'.$num.":AC".$num)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A6:AC6')->getFont()->setBold(true);
        $objPHPExcel->getActiveSheet()->getStyle("M2")->getFont()->setBold(true)->setName('Arial Black');
        $objPHPExcel->getActiveSheet()->getStyle('M2:AC2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

/*        $a = $num;
        $objPHPExcel->getActiveSheet()->setCellValue('S'.$a.":T".$a, "TOTAL");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('U'.$a.":W".$a, $totalsales);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.$a.":Z".$a, $totalcost);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.$a.":AC".$a, $grossprofit);*/
