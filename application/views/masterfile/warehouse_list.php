                ...
                <div class="card">
                    <div class="card-body">
                        <div class="main-button-center">
                            ...
                            <button type="button" class="btn btn-gradient-primary btn-md" data-toggle="modal" data-target="#addWarehouse">
                        ...
                        <table class="table table-bordered table-hover" id="myTable">
                            ...
                            <tbody>
                                <td></td>
                                <td>
                                    <a href="" class="btn btn-sm btn-gradient-info" data-toggle="modal" data-target="#updateWarehouse"><span class="mdi mdi-pencil"></span></a>
                                    <a href="" class="btn btn-sm btn-gradient-danger" data-toggle="modal" data-target="#deleteWarehouse"><span class="mdi mdi-delete"></span></a>
                                </td>
                            </tbody>                            
                        </table>
                    </div>
