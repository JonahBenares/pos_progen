    ...
    <div class="content-wrapper">    
        <div class="page-header">
            <h3 class="page-title">
                ...
                </span> Return (Goods and Services)
            </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">
                        <span></span>Return (Goods and Services) &nbsp;
                        ...
                        <form method="POST">  
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <input type="button" class="btn btn-md btn-gradient-success btn-block" name="" value="Search" onclick="loadReturn()">
                                </div>
                            </div>
                        </form>
                        <hr> 
                        <form id="returnSave">
                            ...
                            <table class="table table-bordered table-hover" width="100%" id="myTdable">
                                ...
                                <tbody>
                                    ...
                                    <input type='hidden' name='transaction_type' value="<?php echo $i['transaction_type']; ?>">
                                    <?php $x++; }  ?>
