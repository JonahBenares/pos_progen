                        ...
                        <form id="service_item">                        
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <label >Rate</label>
                                                <input type="number" class="form-control amount-txt" name="" id="" placeholder="Rate">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <label>Unit</label>
                                                <input type="text" class="form-control " name="unit_cost" id="unit_cost" placeholder="Unit" >
                                            </div>
                                        </div>
                                    </div>
                                </div>                             
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label >Days</label>
                                        <input type="text" class="form-control" name="serial_no" id="serial_no" placeholder="Days">
                                    </div>                               
                                </div>
                                <div class="col-md-6 col-sm-6">   
                                    <div class="form-group">
