...
INSERT INTO `fifo_in` (`in_id`, `receive_id`, `rd_id`, `ri_id`, `receive_date`, `pr_no`, `item_id`, `supplier_id`, `brand_id`, `catalog_no`, `serial_no`, `quantity`, `remaining_qty`) VALUES
(1, 1, 1, 1, '2022-03-04', '092893832', 1, 1, 1, '123', '123', '2.00', '2.00');
...
--
ALTER TABLE `sales_good_details`
MODIFY `sales_good_det_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT for table `sales_good_head`
--
ALTER TABLE `sales_good_head`
MODIFY `sales_good_head_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
