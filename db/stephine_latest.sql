...
INSERT INTO `damage_details` (`damage_det_id`, `damage_id`, `in_id`, `damage_qty`, `remarks`) VALUES
(1, 7, 3, '5.00', 'asd56asddsa');
...
(7, '2022-03-15', 'asdasd', 1, '2022-03-15 16:32:47', 1);
...
(1, 1, 1, 1, '2022-03-20', 'pr1001_1', 1, 7, 'brand1', 'cat1', 'serial1', '2022-04-30', '25000.00', '5.00', '0.00'),
(2, 1, 1, 2, '2022-03-24', 'pr1001_1', 2, 4, 'brand2', 'cat2', 'serial2', '', '1500.00', '10.00', '5.00'),
(3, 1, 2, 3, '2022-03-22', 'pr1001_2', 1, 5, 'brand3', 'cat3', 'serial3', '', '30000.00', '12.00', '0.00');
...
(1, 1, 1, 'Sales Goods', 1, 1, 0, 0, '5.00'),
(2, 3, 1, 'Sales Goods', 1, 1, 0, 0, '2.00'),
(3, 3, 1, 'Sales Goods', 2, 2, 0, 0, '5.00'),
(4, 2, 2, 'Sales Goods', 2, 3, 0, 0, '5.00'),
(5, 3, 1, 'Damage', 0, 0, 0, 7, '5.00'),
(11, 2, 2, 'Sales Goods', 3, 4, 0, 0, '5.00'),
(12, 2, 2, 'Sales Services', 1, 0, 1, 0, '5.00'),
(13, 2, 2, 'Sales Goods', 2, 2, 0, 0, '5.00');
...
(1, 'MRIF-2022-03-0001', '2022-03-09 19:57:16', '2022-03-24', 'dr1001', 'po1001', 'or1001', 1, 1, 1, NULL, 0, 0, 0, 'testing overall remarks for receive transaction 1'),
(2, 'MRIF-2022-03-0002', '2022-03-15 09:42:38', '2022-03-15', 'DR1001', 'PO1001', '5454', 1, 1, 0, NULL, 0, 0, 0, '4445');
...
(1, 1, 1, 7, 1, 'brand1', 'cat1', 'serial1', '25000.00', '5.00', '5.00', 1, '2000.00', '2022-04-30'),
(2, 1, 1, 4, 2, 'brand2', 'cat2', 'serial2', '1500.00', '9.00', '10.00', 1, '200.00', ''),
(3, 2, 1, 5, 1, 'brand3', 'cat3', 'serial3', '30000.00', '12.00', '12.00', 1, '25000.00', '');
...
(2, 2, 2, '5.00', '1500.00', '1500.00', '1600.00', '5.00', '400.00', '7600.00', 1);
...
INSERT INTO `sales_services_head` (`sales_serv_head_id`, `client_id`, `sales_date`, `jor_no`, `jor_date`, `joi_no`, `joi_date`, `dr_no`, `vat`, `purpose`, `create_date`, `user_id`, `remarks`, `saved`) VALUES
(1, 1, '2022-03-16', 'JOR 2021-1', '2022-03-16', 'PJO2022-03-1000', '2022-03-17', 'DR1001', 1, 'asdasd', '2022-03-16 15:42:46', 1, 'asdasdasd', 1);
...
(1, 1, 2, '5.00', '1500.00', '1500.00', '1600.00', '5.00', '400.00', '7600.00', 1);
...
--
ALTER TABLE `damage_head`
MODIFY `damage_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
